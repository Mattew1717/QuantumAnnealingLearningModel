...
if __name__ == '__main__':
    ...
    csv_path = "C:/Users/Matteo/Documents/GitHub/projects/QuantumLearningModel/datasets/04_seeds_1_2.csv"
    
    X, y = load_csv_dataset(csv_path)
    DATA_INPUT_DIM = X.shape[1]
    TRAINING_SAMPLES = int(len(y) * PERCENT_TRAIN)
    TEST_SAMPLES = len(y) - TRAINING_SAMPLES
    ...
    plot_confusion_matrix_scientific(test_set.y.numpy(), predictions, save_path=cm_path)
